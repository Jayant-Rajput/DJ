...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-10 bg-black bg-opacity-70 py-4 px-6 transition-transform duration-300 ${showNavbar ? 'translate-y-0' : '-translate-y-100'}`}>
