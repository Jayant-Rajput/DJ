    ...
    const CardPastContest = ({ contest }) => {
        ...
        return (
            <div className="bg-white shadow-md rounded-2xl p-4 m-4 max-w-md">
                ...
                <p className="text-gray-600 mb-1">Start Time: {new Date(contest.raw_start_time).toLocaleString()}</p>
                <p className="text-gray-600 mb-1">Duration: {Math.floor(contest.raw_duration / 3600000)} hrs</p>
                <a
                    href={contest.url}
                    target="_blank"
    ...
    export default CardPastContest;
